...
public:
	...
	threeonion operator+(const threeonion& right) const
	{
		threeonion out;
	...
	threeonion operator/(const float& right) const
	{
		threeonion out;
	...
	size_t vertex_length = 3;
	vector<float> vertex_data;
};

threeonion conj_number_type(threeonion& in)
{
	threeonion out;
...
threeonion pow_number_type(threeonion& in, float exponent)
{
